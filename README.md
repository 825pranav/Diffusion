...
| Against an LLM agent | a local 7B reasoning over the same graph sits near chance (AUC 0.571, n=15); the classifier reaches 0.938 |
| Anomaly detection | a median/MAD baseline cuts false alarms from **5.06 to 1.44 per topic-day** (3.5×) against z-score, at equal detection delay |
...
| Anomaly baselines | median/MAD cuts false alarms from 5.06 to 1.44 per topic-day (3.5×) vs z-score, at comparable delay |
