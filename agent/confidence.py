...
not chosen by feel: 0.85 is the lowest gate whose retained predictions hold 90%
accuracy on the held-out split, which auto-publishes roughly three quarters of
cases and sends the rest to a human. It replaces a guessed 0.65, which published
a band where the model is measurably not that reliable.
